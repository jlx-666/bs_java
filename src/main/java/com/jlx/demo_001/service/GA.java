...
public interface GA {
    ...
    //public static int countChoice = 20;                         //试卷选择题数量
    public static int countBlanks = 0;                         //试卷填空题数量
    public static int countWordProblem = 0;                     //试卷应用题数量
    ...
    public abstract Paper getPaperByGA(Double difficult,int countchoice);            //通过交叉，变异等操作筛选出目标试卷
